    ...
    const buildCategoryKeywordIndex = (categories) => {
        ...
        for (const c of categories || []) {
            ...
            if (
                ...
                keywords = [
                    "study", "homework", "revision", "revise", "read", "reading",
                    "school", "class", "lesson", "tutor", "tuition", "exam", "quiz",
                    "assignment", "project", "research", "coding", "code", "program",
                    "leetcode", "学习", "作业", "复习", "阅读", "上课", "补习",
                    "考试", "测验", "项目", "编程",
                ];
            } else if (
                lower === "entertainment" ||
                ...
                keywords = [
                    "game", "gaming", "youtube", "video", "tv", "movie", "netflix",
                    "tiktok", "music", "play", "fun", "动漫", "游戏", "视频",
                    "电视", "电影", "音乐", "娱乐",
                ];
            } else if (
                lower === "social" ||
                ...
                keywords = [
                    "chat", "call", "meet", "party", "hangout", "family", "friend",
                    "friends", "talk", "social", "dinner", "聚会", "聊天", "通话",
                    "见面", "朋友", "家人", "社交",
                ];
            } else if (
                lower === "exercise" ||
                ...
                keywords = [
                    ...
                    "sport", "training", "swim", "swimming", "basketball", "football",
                    "soccer", "tennis", "yoga", "跑步", "散步", "健身", "运动",
                    "训练", "游泳", "篮球", "足球", "瑜伽",
                ];
            } else if (
                lower === "sleep" ||
                ...
                keywords = [
                    "sleep", "nap", "bed", "rest", "wake", "wakeup", "night",
                    "睡", "睡觉", "午睡", "休息", "起床",
                ];
            }
